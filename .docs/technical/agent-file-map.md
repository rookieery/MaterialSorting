...
| `CALIBRATION_DIR` | `OUT_DIR/portfolio_calibration`（PC-004 标定管线产物根：cli.calibration batch/variants/analyze 的曲线与分析，gitignore 区） | — |
