...
//     （POST /api/prefix-preview：前×2 + 后×2 同码 paired 同型成对竖排贴靠 =
//     求解时 PS_ 组合片的精确形态，2026-09-03 成员序改判后后前前）—— 原「两码各一张 80×80 原始裁片缩略」与下方裁片
        ...
        ? createPortal(
            ...
            >
              ...
              >
                ...
                <div className="band-zoom-hint dim small">
                  预览 = 求解时前缀组合片的精确形态（4 片同码 paired 同型成对竖排贴靠 ·
                  头尾相对 180°；标注 = 成员 g 码）
