...
export const nestingTour: TourDef = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: '编辑排料',
      body: '想人工微调结果时点「编辑」打开排料画布：左键拖动裁片、拖旋转手柄转角；按住 Alt 再用左键拖动、松手后自动吸附贴靠邻片（纯左键拖动不吸附）；空格循环镜像姿态、L / K 键逐度旋转。「智能微调」一键清理重合与歪斜（可撤销，不自动保存），改完点「保存当前布局」写回主界面；「重置」可放弃全部编辑恢复初始布局。',
      placement: 'right',
      before: ensureNestingTab,
      ready: hasProducedFrame,
